...
public class ColorMain extends Module
{
    ...
    public static Value.Mode friendcolor;
    public static Value.Mode enemycolor;
    ...
    public void setup() {
        ...
        tab.add("White");
        ColorMain.friendcolor = this.registerMode("Friend", "FriendColor", (List)tab, "Blue");
        ColorMain.enemycolor = this.registerMode("Enemy", "EnemyColor", (List)tab, "Red");
    }
