...
public class OffhandGap extends Module
{
    ...
    public OffhandGap() {
        super("OffhandGap", Module.Category.Combat);
        this.moving = false;
        this.returnI = false;
    }
    ...
    private boolean shouldTotem() {
        final boolean hp = OffhandCrystal.mc.player.getHealth() + OffhandCrystal.mc.player.getAbsorptionAmount() <= this.health.getValue();
