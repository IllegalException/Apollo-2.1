...
public class Value
{
    ...
    public Value(final String name, final String configname, final Module parent, final Module.Category category, final Type type) {
        this.name = name;
    ...
    public static class Mode extends Value
    {
        private String value;
        private final List<String> modes;
        
        public Mode(final String name, final String configname, final Module parent, final Module.Category category, final List<String> modes, final String value) {
